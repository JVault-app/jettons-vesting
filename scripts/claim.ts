...
export async function run(provider: NetworkProvider) {
    ...
    const sbt = provider.open(JettonVesting.createFromAddress(Address.parse("EQCqWOSjkY6iyH_BqSum2GUXqEvEFWB0pRKzfeAsYdkjU8NG")))
    await sbt.sendClaim(provider.sender(), toNano("0.1"))
